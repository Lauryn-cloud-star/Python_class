...
galápagos_tortoise = Tortoise("galapagos","small", "brown", "slow", "testudines", "stays on land", "herbivore")

# print the details of galápagos_tortoise inherited from the class Reptiles
galápagos_tortoise.details()

# printing the reproduction method for the tortoise object
print(f"{galápagos_tortoise.name} {galápagos_tortoise.reproduction()}")
